...
export default function AdminDashboard() {
  ...
  return (
    <>
      ...
      <h2 className="text-xl sm:text-3xl font-medium font-Gidugu">అడ్మిన్ డాష్‌బోర్డ్‌కు స్వాగతం <br /><span className="text-center flex justify-center"> {currentUser?.name} {" "} గారు</span></h2>
