...
export default function NewsIdPage({params}: {params: Promise<{newsId: string}>}) {
    ...
    newsArticles.length === 0 ? (
        ...
        newsArticles.map((article) => (
            <div key={article._id} className='flex flex-col items-center mx-0.5 '>
                <Image src={article.image} alt={article.newsTitle} width={50} height={50} className="rounded-md w-80 h-60 my-1 object-contain  " />
                <div>
