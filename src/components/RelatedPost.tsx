...
export default function RelatedPost({
  ...
  return (
    <div className="w-full lg:w-1/3 mt-8 lg:mt-0">
      <h3 className="text-xl sm:text-2xl font-telugu font-bold mb-6">
            ...
            >
              <div className="max-sm:w-1/3">
                ...
                <CldImage
                  ...
                  fetchPriority="high"
                  placeholder="blur"
                  blurDataURL={`https://res.cloudinary.com/djthwdebh/image/upload/w_10,h_6,e_blur:1000,q_auto,f_auto/${extractPublicId(
                    post.image
                  )}`}
              ...
              <div className="p-2 max-sm:w-full">
                ...
                <div className="p-1 flex items-center gap-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1 font-telugu">
                    {" "}
